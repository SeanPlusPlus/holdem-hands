  ...
  return (
    <div className={`modal ${modal && modal.about}`}>
      <div className="modal-box relative">
        ...
        <div>
          <p className="pb-3">
            This is a tool for studying the quality of Texas Hold&apos;em starting hands. It was inspired by <a className="link text-sky-500" href="https://en.wikipedia.org/wiki/Texas_hold_%27em_starting_hands" rel="noopener noreferrer" target="_blank">this Wikipedia entry</a>. Simply put, the better the hand, the lower the score.
          </p>
          <Image
            src="/table1.png"
            width={400}
